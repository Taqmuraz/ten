...
(def-uniform :mat (gl:uniform-matrix loc 4 (-> value transponed-4x4 mat-4x4->vec-16 vector)))
(def-uniform :mats (gl:uniform-matrix loc 4 (map 'vector (lambda (x) (-> x transponed-4x4 mat-4x4->vec-16)) value)))
